...
export const LowersWaveReport: React.FC<LowersWaveReportProps> = ({
  ...
  const isSelectedToday = selectedDayIndex === status.dayIndex;
        ...
        <div className="relative z-10 max-w-4xl space-y-4">
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            >
              ...
              Today&apos;s Tune: {status.todayProfile.title} &bull; {status.todayProfile.optimization}
            </span>
            <span className="text-xs text-slate-400 font-medium hidden sm:inline-flex items-center gap-1">
              <Clock className="w-3 h-3" />
              {status.formattedDate} (Bend, OR)
            </span>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-300 text-sm sm:text-base mt-2 max-w-3xl leading-relaxed">
              Also known as{" "}
              <strong className="text-white font-semibold">Jason&apos;s Wave</strong>.
              Gets a custom tune by our wave shapers every other day.
            </p>
          </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <h2 className="font-bold text-white text-base">
                    Active Tuning Profile: {status.todayProfile.title}
                  </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mb-4">
              Tuned as a glassy low-gradient wave. Ideal for surfing your
              favorite longboard. Provides a mellow front surf in your kayak.
            </p>
          ...
          <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
            <span>Wave Shaper Rhythm</span>
            <span className="font-semibold text-slate-700">Every Other Day</span>
          </div>
        </div>
        ...
        >
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mb-4">
              Tuned as more of a friendly wave-hole with a nice pile. Ideal for
              mellow spins in your kayak. Great for boogie boards. Shorter
              high-volume longboards also work OK.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
          ...
          <div className="p-4 rounded-xl bg-slate-50/80 border border-slate-200 flex flex-col justify-between">
            ...
            <div className="mt-3 pt-2 border-t border-slate-200/60 text-[11px] text-slate-500 font-medium">
              Tip: Single-fin or 2+1 with plenty of forward volume.
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-50/80 border border-slate-200 flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                ...
                days. Mellow spins, side-surfing, and play in the pile on{" "}
                <strong className="text-slate-800">Wave Hole</strong> days.
              </p>
            </div>
            <div className="mt-3 pt-2 border-t border-slate-200/60 text-[11px] text-slate-500 font-medium">
              Tip: Playboats and river runners both enjoy this feature.
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-50/80 border border-slate-200 flex flex-col justify-between">
            ...
            <div className="mt-3 pt-2 border-t border-slate-200/60 text-[11px] text-slate-500 font-medium">
              Tip: Standard bodyboards with swim fins for quick entry.
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-50/80 border border-slate-200 flex flex-col justify-between">
            ...
            <div className="mt-3 pt-2 border-t border-slate-200/60 text-[11px] text-slate-500 font-medium">
              Tip: Check Upper Wave discharge (currently {displayFlow(data.current.flowCfs)}).
            </div>
          </div>
        </div>
      </div>
